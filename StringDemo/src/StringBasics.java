public class StringBasics {
	public static void main(String[] args) {
		...
		if (s1 == s2) { // shallow comparison
			System.out.println(" s1 == s2  ::: references/identities are equal"); // never
																	// reaches
																	// here
		}
		if (s1.equals(s2)) { // deep comparison
			System.out.println("s1.equals(s2::: values are equal"); // this line is printed
		}
		...
		if (s3 == s4) { // shallow comparison
			System.out.println("s3 == s4  ::: references/identities are equal"); // this line
																	// is
																	// printed
		}
		if (s3.equals(s4)) { // deep comparison
			System.out.println(" s3.equals(s4) :: values are equal"); // this line is also printed
		}
	}
}