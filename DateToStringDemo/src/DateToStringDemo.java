...
public class DateToStringDemo{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            System.out.println(date); // Thu Feb 06 00:00:00 IST 2014

        } catch (ParseException e) {
            e.printStackTrace();
        }
        
        String string1 = "March 7, 2015";
        Date date1;
        try {
            date1 = new SimpleDateFormat("MMMM d, yyyy").parse(string1);
            System.out.println(date1); // Thu Feb 06 00:00:00 IST 2014
        ...
        try {
            ...
            System.out.println(date); // Thu Jan 09 00:00:00 IST 2014
        } catch (ParseException e) {
            e.printStackTrace();
        }
        ...
        try {
            ...
            System.out.println(date); // Sat Jan 04 20:30:00 IST 2014
        } catch (ParseException e) {
            e.printStackTrace();
        }
        ...
        try {
            ...
            System.out.println(date); //Sun Jan 30 00:01:00 IST 2011
        } catch (ParseException e) {
            e.printStackTrace();
        }
        ...
        try {
            ...
            System.out.println(mydate);  //Tue Feb 04 00:00:00 IST 2014
        } catch (ParseException e) {
